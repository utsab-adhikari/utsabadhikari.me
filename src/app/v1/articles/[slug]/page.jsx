        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="mb-6">
            <button
              ...
              className="flex items-center text-[#7d8590] hover:text-[#f0f6fc] transition-colors text-sm"
            >
            ...
            <div className="flex-1">
              {article.featuredImage && (
                <img
                  ...
                  alt={article.title}
                  className="w-full h-48 md:h-64 object-cover rounded-md mb-6 border border-[#30363d]"
                />
              )}

              <article className="bg-[#161b22] rounded-md p-4 md:p-6 border border-[#30363d]">
                <div
                  className="text-[#f0f6fc] prose prose-lg max-w-none  whitespace-pre-wrap prose-headings:text-[#f0f6fc] prose-a:text-[#2f81f7] prose-strong:text-[#f0f6fc] prose-code:text-[#f0f6fc] prose-code:bg-[#0d1117] prose-code:p-1 prose-code:rounded prose-code:border prose-code:border-[#30363d] prose-pre:bg-[#0d1117] prose-pre:border prose-pre:border-[#30363d]"
