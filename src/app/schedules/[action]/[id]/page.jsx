          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              {formData.content.map((item, index) => (
                <div key={index} className="bg-[#0d1117] border border-[#30363d] rounded-md p-4 mb-4">
                  <div className="flex justify-between items-center mb-3">
                    <h4 className="text-sm font-medium text-[#f0f6fc]">Item {index + 1}</h4>
                    <button
                      type="button"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value={item.subTitle}
                        onChange={(e) => updateContentItem(index, "subTitle", e.target.value)}
                    ...
                    <div>
                      ...
                      <input
                        type="date"
                        value={item.date}
                        onChange={(e) => updateContentItem(index, "date", e.target.value)}
                        className="w-full px-3 py-1 bg-[#161b22] border border-[#30363d] rounded-md text-sm text-[#c9d1d9]"
                        disabled={saving}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        type="time"
                        value={item.time}
                        onChange={(e) => updateContentItem(index, "time", e.target.value)}
                        className="w-full px-3 py-1 bg-[#161b22] border border-[#30363d] rounded-md text-sm text-[#c9d1d9]"
                        disabled={saving}
                      />
                    </div>
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-[#30363d]">
              ...
              >
                ...
                {saving ? (isEdit ? "Updating..." : "Creating...") : (isEdit ? "Update Schedule" : "Create Schedule")}
              </button>
            </div>
          </form>
        </div>
